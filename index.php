<?php include 'header.php' ?>
   ...
   <article class="hero index-hero">
		<header>
			<h1>Blurb about our service.</h1>
			<h2>Mini description goes in here, enticing people to use the search below.
			Go on, try searching for a topic like [fill in with a query we have results for]</h2>
		</header>
		<form class="search">
			<input type="text">
			<div class="dropdown">
				<a class="btn dropdown-toggle" data-toggle="dropdown">Content types</a>
			</div>
			<div class="dropdown">
				<a class="btn dropdown-toggle" data-toggle="dropdown">Difficulty</a>
			</div>
